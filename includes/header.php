        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item">
                        <a class="nav-link px-3 <?php echo ($current_page == 'index.php') ? 'active' : ''; ?>" href="index.php">Home</a>
                    </li>

                    <?php if ($is_logged_in): ?>
                        <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                            <li class="nav-item">
                                <a class="nav-link px-3 text-success fw-bold <?php echo ($current_page == 'admin.php') ? 'active' : ''; ?>" href="admin.php">Admin</a>
                            </li>
                        <?php endif; ?>
                        <li class="nav-item">
